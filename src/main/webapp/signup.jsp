...
<head>
<meta charset="UTF-8">
<title>Expense Reimbursement System &#8212; Sign Up</title>
...
<body>
	...
	%>
	<h1>Expense Reimbursement System &#8212; Sign Up</h1>
	<hr/>
	<%
		if (message != null)
	...
	<form action="SignupController" method="post">
		<table>
			...
			<tr>
				<td><select name="mgremp" id="mgremp" onclick="mgrempChk()">
